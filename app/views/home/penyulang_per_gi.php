...
<div class="p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <h2 class="text-2xl font-bold text-gray-800">Statistik - Jumlah Penyulang per GI</h2>
        ...
        <table class="min-w-full">
            <thead class="bg-gray-50 border-b">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">Nama Gardu Induk</th>
                    <th class="px-6 py-3 text-center text-sm font-semibold text-gray-700">Total Penyulang</th>
                </tr>
            </thead>
                ...
                <?php if (!empty($data)): ?>
                    ...
                    <?php foreach ($data as $row): ?>
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-3 text-sm text-gray-800">
                                <?= htmlspecialchars($row['nama_gi'], ENT_QUOTES, 'UTF-8') ?>
                            </td>
                            <td class="px-6 py-3 text-sm text-center font-semibold text-gray-800">
                                <?= htmlspecialchars($row['total_penyulang'], ENT_QUOTES, 'UTF-8') ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
