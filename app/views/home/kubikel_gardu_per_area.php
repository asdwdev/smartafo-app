...
<div class="p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <h2 class="text-2xl font-bold text-gray-800">Statistik - Kubikel Gardu per Area</h2>
        ...
        <table class="min-w-full">
            <thead class="bg-gray-50 border-b">
                <tr>
                    ...
                    <th class="px-6 py-3 text-center text-sm font-semibold text-gray-700">Total Kubikel Gardu</th>
                </tr>
            </thead>
                    ...
                    <?php foreach ($data as $row): ?>
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-3 text-sm text-center font-semibold text-gray-800">
                                <?= htmlspecialchars($row['total_kubikel'], ENT_QUOTES, 'UTF-8') ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="3" class="px-6 py-6 text-center text-gray-500 text-sm">
                            Tidak ada data kubikel gardu per area.
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
