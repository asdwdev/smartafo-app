...
<div class="p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        <h2 class="text-2xl font-bold text-gray-800">Statistik - Jumlah Gardu per Penyulang</h2>
        ...
        <table class="min-w-full">
            <thead class="bg-gray-50 border-b">
                <tr>
                    ...
                    <th class="px-6 py-3 text-center text-sm font-semibold text-gray-700">Total Gardu</th>
                </tr>
            </thead>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4" class="px-6 py-6 text-center text-gray-500 text-sm">
                            Tidak ada data gardu per penyulang.
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
