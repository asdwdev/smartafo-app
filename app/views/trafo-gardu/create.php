...
<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8">
    <h3 class="text-xl font-bold text-gray-800 mb-6">Tambah Trafo Gardu</h3>

    <!-- Form -->
    <form method="POST" action="/trafo-gardu" class="space-y-5">
            ...
            focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-sm px-3 py-2">
                ...
                <?php foreach ($trafos as $t): ?>
                    <option value="<?= $t['trafo_id'] ?>"
                        <?= ($old['trafo_id'] ?? '') == $t['trafo_id'] ? 'selected' : '' ?>>
        ...
        <div>
            ...
            <input type="date" id="tgl_pasang" name="tgl_pasang"
                value="<?= htmlspecialchars($old['tgl_pasang'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="date" id="tgl_operasi" name="tgl_operasi"
                value="<?= htmlspecialchars($old['tgl_operasi'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="status_operasi" name="status_operasi"
                value="<?= htmlspecialchars($old['status_operasi'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <div class="flex gap-6">
                ...
                foreach ($options as $option):
                    $checked = ($old['kondisi_fisik'] ?? '') === $option ? 'checked' : '';
                ?>
        ...
        <div>
            ...
            <input type="text" id="posisi_arde" name="posisi_arde"
                value="<?= htmlspecialchars($old['posisi_arde'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="arah_fasa" name="arah_fasa"
                value="<?= htmlspecialchars($old['arah_fasa'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
