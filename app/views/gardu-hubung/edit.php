...
<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8">
    <h3 class="text-xl font-bold text-gray-800 mb-6">Edit Data Gardu Hubung</h3>

    <!-- Form -->
    <form method="POST" action="/gardu-hubung/<?= $id ?>" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" id="kode_gh" name="kode_gh"
                ...
                class="mt-1 block w-full rounded-lg border <?= !empty($errors['kode_gh']) ? 'border-red-500' : 'border-gray-400' ?> bg-white text-gray-900 
        ...
        <div>
            ...
            <input type="text" id="nama_gh" name="nama_gh"
                ...
                class="mt-1 block w-full rounded-lg border <?= !empty($errors['nama_gh']) ? 'border-red-500' : 'border-gray-400' ?> bg-white text-gray-900 
                          shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-sm px-3 py-2">
...
<script>
    ...
    const latVal = parseFloat(latInput.value) || -6.2;
