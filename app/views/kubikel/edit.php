...
<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8">
    <h3 class="text-xl font-bold text-gray-800 mb-6">Edit Kubikel</h3>

    <!-- Form -->
    <form method="POST" action="/kubikel/<?= $id ?>" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" id="no_seri" name="no_seri"
                value="<?= htmlspecialchars($old['no_seri'] ?? $kubikel['no_seri'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                class="mt-1 block w-full rounded-lg border <?= !empty($errors['no_seri']) ? 'border-red-500' : 'border-gray-400' ?>
                       bg-white text-gray-900 shadow-sm 
                       focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-sm px-3 py-2" required>
        ...
        <div>
            ...
            <input type="text" id="merk" name="merk"
                value="<?= htmlspecialchars($old['merk'] ?? $kubikel['merk'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="jenis" name="jenis"
                value="<?= htmlspecialchars($old['jenis'] ?? $kubikel['jenis'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="fungsi" name="fungsi"
                value="<?= htmlspecialchars($old['fungsi'] ?? $kubikel['fungsi'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="number" step="0.001" id="tegangan_kv" name="tegangan_kv"
                value="<?= htmlspecialchars($old['tegangan_kv'] ?? $kubikel['tegangan_kv'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="number" step="0.01" id="kapasitas_a" name="kapasitas_a"
                value="<?= htmlspecialchars($old['kapasitas_a'] ?? $kubikel['kapasitas_a'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="number" step="0.001" id="impedansi_persen" name="impedansi_persen"
                value="<?= htmlspecialchars($old['impedansi_persen'] ?? $kubikel['impedansi_persen'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <textarea id="catatan" name="catatan"
                class="mt-1 block w-full rounded-lg border <?= !empty($errors['catatan']) ? 'border-red-500' : 'border-gray-400' ?>
                       bg-white text-gray-900 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-sm px-3 py-2"><?= htmlspecialchars($old['catatan'] ?? $kubikel['catatan'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
