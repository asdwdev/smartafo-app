...
<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8">
    <h3 class="text-xl font-bold text-gray-800 mb-6">Tambah Kubikel Gardu</h3>

    <!-- Form -->
    <form method="POST" action="/kubikel-gardu" class="space-y-5">
            ...
            <select id="kubikel_id" name="kubikel_id"
                ...
                <?php foreach ($kubikels as $k): ?>
                    <option value="<?= $k['kubikel_id'] ?>"
                        <?= ($old['kubikel_id'] ?? '') == $k['kubikel_id'] ? 'selected' : '' ?>>
        ...
        <div>
            ...
            <input type="text" id="status_rc" name="status_rc"
                value="<?= htmlspecialchars($old['status_rc'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="arah_gardu" name="arah_gardu"
                value="<?= htmlspecialchars($old['arah_gardu'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="ct_info" name="ct_info"
                value="<?= htmlspecialchars($old['ct_info'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="vt_info" name="vt_info"
                value="<?= htmlspecialchars($old['vt_info'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="relay_info" name="relay_info"
                value="<?= htmlspecialchars($old['relay_info'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="fuse_info" name="fuse_info"
                value="<?= htmlspecialchars($old['fuse_info'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
