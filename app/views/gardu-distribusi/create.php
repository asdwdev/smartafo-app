...
<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8">
    <h3 class="text-xl font-bold text-gray-800 mb-6">Tambah Gardu Distribusi</h3>

    <form method="POST" action="/gardu-distribusi" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" id="kode_gardu" name="kode_gardu"
                value="<?= htmlspecialchars($old['kode_gardu'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
        ...
        <div>
            ...
            <input type="text" id="nama_gardu" name="nama_gardu"
                value="<?= htmlspecialchars($old['nama_gardu'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                class="mt-1 block w-full rounded-lg border 
        ...
        <div>
            ...
            <?php if (!empty($errors['latitude'])): ?>
                <p class="mt-1 text-sm text-red-600">
                    <?= htmlspecialchars($errors['latitude'][0], ENT_QUOTES, 'UTF-8') ?>
                </p>
            <?php endif; ?>
        </div>
        ...
        <div>
            ...
            <textarea id="keterangan" name="keterangan" rows="2"
                class="mt-1 block w-full rounded-lg border 
                  ...
                  bg-white text-gray-900 shadow-sm 
                  focus:border-blue-500 focus:ring-2 focus:ring-blue-500 text-sm px-3 py-2"><?= htmlspecialchars($old['keterangan'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
